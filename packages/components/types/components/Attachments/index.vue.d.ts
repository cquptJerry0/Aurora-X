...
declare const __VLS_component: import('vue').DefineComponent<AttachmentsProps, {}, {}, {}, {}, import('vue').ComponentOptionsMixin, import('vue').ComponentOptionsMixin, {
    uploadDrop: (...args: any[]) => void;
    uploadChange: (...args: any[]) => void;
    deleteFile: (...args: any[]) => void;
}, string, import('vue').PublicProps, Readonly<AttachmentsProps> & Readonly<{
